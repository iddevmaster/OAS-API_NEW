  ...
  while (currentDate <= endDate) {
    ...
    if(LoaDay){
      ...
      if(getContent[0]?.numRows == 0){
        ...
        [2, data.ap_quota,data.ap_date_start,data.ap_date_end,currentDate.toISOString().split('T')[0],'-','-',functions.dateAsiaThai(),functions.dateAsiaThai(), user_id,user_id,time,user_full,user_full]
